...
class Master {
 ...
 private:
  ...
  void send_data(const asio::ip::udp::endpoint& remote_endpt,
                 asio::const_buffer& buf);
  void send_data();

  void send_timesync();

  void send_initial_timesync(const asio::ip::udp::endpoint& remote_endpt,
                             MConnection& cxn);
  void send_final_timesync(const asio::ip::udp::endpoint& remote_endpt,
  ...
  asio::deadline_timer* start_timer(const asio::ip::udp::endpoint& remote_endpt,
